...
export const socials: SocialLink[] = [
  ...
  },
  {
    platform: 'discord',
    label: 'Discord',
    url: 'https://discord.com/users/gosofiade',
  ...
  },
  {
    platform: 'email',
    label: 'Email',
    url: 'mailto:gosofiade@gmail.com',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="20" height="20"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>',
  },
  {
    platform: 'vgen',
    label: 'VGen',
